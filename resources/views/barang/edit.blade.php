                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nama" class="form-control" value="{{$barangs->nama}}" placeholder="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="harga" class="form-control" value="{{$barangs->harga}}" placeholder="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="quantity" class="form-control" value="{{$barangs->quantity}}" placeholder="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="email" class="form-control" value="{{$barangs->email}}" placeholder="" required>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="telp" class="form-control" value="{{$barangs->telp}}" placeholder="" required>
                            </div>
                        </div>
                        <div class="px-3">
                            <button class="btn btn-outline-primary btn-sm">Save</button>
                            <a href="{{route('barang.index')}}" class="btn btn-outline-info btn-sm">Cancel</a>
                        </div>
                    </div>
                </div>
