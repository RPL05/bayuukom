...
<div class="d-flex bd-cheatsheet container-fluid bg-body">
    <div class="col-md-2" style="margin-top : -28px">
        <section id="content">
            <h5 class="sticky-xl-top fw-bold pt-3 pt-xl-5 pb-2 pb-xl-3" style="margin-left : 50px">{{ auth()->user()->roles->first()->name }}</h5>
            <article>
            ...
            <div class="col-md-12">
                    ...
                    <div class="col-md-3">
                        <div class="card border-0 shadow">
                            <div class="card-body d-flex">
                                ...
                                <h4 class="ml-auto">{{ $totalrequest }}</h4>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-3">
                ...
                <div class="container">
                    <div class="col-md-12" style="margin-left : 20px">
                        <h5 class="font-weight-bold mt-4">Data Supliers</h5>
                        ...
                        <div class="container">
                            <h5 class="font-weight-bold mt-4">Data Barang</h5>
                            <table class="table table-striped mt-4">
                                <thead>
                                <tr class="">
                                    <th>Kode Barang</th>
