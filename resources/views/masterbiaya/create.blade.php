    ...
    <div class="row d-flex justify-content-center">
      <div class="col-md-6">
        ...
        <div class="card border-0 shadow">
          <div class="card-body">
            <form action="{{ route('masterbiaya.store') }}" method="post">
                @csrf
                @if(session('success'))
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" name="nama_kendaraan" id="nama_kendaraan" value="" class="form-control" required>
                            <span class="text-danger" id="nama_kendaraan"></span>
                        </div>
                        <div class="form-group">
                            <label for="biaya">Biaya</label>
                            <input type="number" name="biaya" id="biaya" value="" class="form-control" required>
