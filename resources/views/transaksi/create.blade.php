                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            ...
                            <input type="text" id="no_nota" value="" class="form-control" required readonly>
                            <span class="text-danger" id="no_nota"></span>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="bayar" id="bayar" value="" class="form-control" required>
                            <span class="text-danger" id="bayar"></span>
                        </div>
                        <div class="form-group">
                            <label for="total_bayar">Total Bayar</label>
                            <input type="number" name="total_bayar" id="total_bayar" value="" class="form-control" required>
